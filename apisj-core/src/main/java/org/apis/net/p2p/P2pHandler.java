...
import static org.apis.net.message.StaticMessages.*;
    ...
    public void setHandshake(HelloMessage msg, ChannelHandlerContext ctx) {
        ...
        for (Capability capability : capInCommon) {
            if (capability.getName().equals(Capability.ETH)) {
                ...
                channel.activateEth(ctx, EthVersion.fromCode(capability.getVersion()));
            } else if
