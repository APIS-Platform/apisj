...
import org.apis.datasource.CountingBytesSource;
import org.apis.datasource.JournalSource;
...
import org.apis.solidity.compiler.CompilationResult.ContractMetadata;
import org.apis.solidity.compiler.SolidityCompiler;
import org.apis.validator.DependentBlockHeaderRuleAdapter;
...
//        withAccountBalance(txSender.getAddress(), new BigInteger("100000000000000000000000000"));
    ...
    public StandaloneBlockchain withAccountBalance(byte[] address, BigInteger weis) {
        ...
        genesis.addPremine(ByteUtil.wrap(address), state);
    ...
    public Block createForkBlock(Block parent) {
        try {
            ...
            time += timeIncrement;
            Block b = getBlockchain().createNewBlock(parent, new ArrayList<>(txes.values()), time);
