...
public class StringManager {
    ...
    public class Setting implements StringManagerImpl {
        ...
        public SimpleStringProperty rpcPortHttpLabel = new SimpleStringProperty();
        ...
        public SimpleStringProperty rpcNThreadsLabel = new SimpleStringProperty();
        ...
        public SimpleStringProperty rpcStartHttpLabel = new SimpleStringProperty();
        ...
        public void update() {
            ...
            rpcPortLabel.set(StringManager.this.getString("setting_rpc_port_label", "WS Port"));
            rpcPortHttpLabel.set(StringManager.this.getString("setting_rpc_port_http_label", "HTTP Port"));
            rpcWhiteListLabel.set(StringManager.this.getString("setting_rpc_white_list_label", "White List"));
            rpcMaxConnectionsLabel.set(StringManager.this.getString("setting_rpc_max_connections_label", "WS Max Connections"));
            rpcNThreadsLabel.set(StringManager.this.getString("setting_rpc_n_threads_label", "HTTP nThreads"));
            ...
            rpcStartLabel.set(StringManager.this.getString("setting_rpc_start_label", "Start WS RPC"));
            rpcStartHttpLabel.set(StringManager.this.getString("setting_rpc_start_http_label", "Start HTTP RPC"));
