...
import org.apis.config.net.MordenNetConfig;
...
public class SystemPropertiesTest {
    ...
    public void testRequireEitherNameOrClassConfiguration() {
        try {
            SystemProperties props = new SystemProperties();
            props.overrideParams("blockchain.config.name", "test", "blockchain.config.class", "TestNetConfig");
            props.getBlockchainConfig();
    ...
    public void testRequireTypeBlockchainNetConfigOnManualClass() {
        SystemProperties props = new SystemProperties();
        props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "TestNetConfig");
    ...
    public void testNotInstanceOfBlockchainForkConfig() {
        ...
        try {
            props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "NodeFilter");
            props.getBlockchainConfig();
            fail("Should throw exception for invalid class");
        } catch (RuntimeException expected) {
