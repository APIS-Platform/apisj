...
import static org.apis.util.ByteUtil.byteArrayToInt;
import static org.apis.util.ByteUtil.wrap;
import static org.apis.util.RLP.*;
...
//        2240089100000070
    ...
    public void testRlpEncode() {
        ...
        Assert.assertEquals(RlpTestData.result01, Hex.toHexString(encode(RlpTestData.test01)));
        Assert.assertEquals(RlpTestData.result02, Hex.toHexString(encode(RlpTestData.test02)));
        Assert.assertEquals(RlpTestData.result03, Hex.toHexString(encode(RlpTestData.test03)));
        Assert.assertEquals(RlpTestData.result04, Hex.toHexString(encode(RlpTestData.test04)));
        Assert.assertEquals(RlpTestData.result05, Hex.toHexString(encode(RlpTestData.test05)));
        Assert.assertEquals(RlpTestData.result06, Hex.toHexString(encode(RlpTestData.test06)));
        Assert.assertEquals(RlpTestData.result07, Hex.toHexString(encode(RlpTestData.test07)));
        Assert.assertEquals(RlpTestData.result08, Hex.toHexString(encode(RlpTestData.test08)));
        Assert.assertEquals(RlpTestData.result09, Hex.toHexString(encode(RlpTestData.test09)));
        Assert.assertEquals(RlpTestData.result10, Hex.toHexString(encode(RlpTestData.test10)));
        Assert.assertEquals(RlpTestData.result11, Hex.toHexString(encode(RlpTestData.test11)));
        Assert.assertEquals(RlpTestData.result12, Hex.toHexString(encode(RlpTestData.test12)));
        Assert.assertEquals(RlpTestData.result13, Hex.toHexString(encode(RlpTestData.test13)));
        Assert.assertEquals(RlpTestData.result14, Hex.toHexString(encode(RlpTestData.test14)));
        Assert.assertEquals(RlpTestData.result15, Hex.toHexString(encode(RlpTestData.test15)));
        Assert.assertEquals(RlpTestData.result16, Hex.toHexString(encode(RlpTestData.test16)));
    }
    ...
    public void testRlpDecode() {
        ...
        emptyString = (String) decode(Hex.decode(RlpTestData.result01), pos).getDecoded();
        assertEquals("", emptyString);

        emptyString = (String) decode(Hex.decode(RlpTestData.result02), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test02, emptyString);

        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result03), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test03, bytesToAscii(decodedData));

        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result04), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test04, bytesToAscii(decodedData));

        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result05), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test05, bytesToAscii(decodedData));

        decodedList = (Object[]) decode(Hex.decode(RlpTestData.result06), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test06[0], bytesToAscii((byte[]) decodedList[0]));
        Assert.assertEquals(RlpTestData.test06[1], bytesToAscii((byte[]) decodedList[1]));

        decodedList = (Object[]) decode(Hex.decode(RlpTestData.result07), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test07[0], bytesToAscii((byte[]) decodedList[0]));
        Assert.assertEquals(RlpTestData.test07[1], bytesToAscii((byte[]) decodedList[1]));
        Assert.assertEquals(RlpTestData.test07[2], bytesToAscii((byte[]) decodedList[2]));

        // 1
        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result08), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test08, byteArrayToInt(decodedData));

        // 10
        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result09), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test09, byteArrayToInt(decodedData));

        // 100
        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result10), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test10, byteArrayToInt(decodedData));

        // 1000
        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result11), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test11, byteArrayToInt(decodedData));

        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result12), pos).getDecoded();
        assertTrue(RlpTestData.test12.compareTo(new BigInteger(1, decodedData)) == 0);

        decodedData = (byte[]) decode(Hex.decode(RlpTestData.result13), pos).getDecoded();
        assertTrue(RlpTestData.test13.compareTo(new BigInteger(1, decodedData)) == 0);

        // Need to test with different expected value, because decoding doesn't recognize types
        Object testObject1 = decode(Hex.decode(RlpTestData.result14), pos).getDecoded();
        assertTrue(DeepEquals.deepEquals(RlpTestData.expected14, testObject1));

        Object testObject2 = decode(Hex.decode(RlpTestData.result15), pos).getDecoded();
        assertTrue(DeepEquals.deepEquals(RlpTestData.test15, testObject2));

        // Need to test with different expected value, because decoding doesn't recognize types
        Object testObject3 = decode(Hex.decode(RlpTestData.result16), pos).getDecoded();
        assertTrue(DeepEquals.deepEquals(RlpTestData.expected16, testObject3));
    }
