...
import org.apis.jsontestsuite.GitHubJSONTestSuite;
...
import static org.apis.jsontestsuite.suite.JSONReader.listJsonBlobsForTreeSha;
import static org.apis.jsontestsuite.suite.JSONReader.loadJSONFromCommit;
import static org.apis.jsontestsuite.suite.JSONReader.loadJSONsFromCommit;
...
public class TxTestSuite {
    ...
    public void run(String testCaseRoot, Set<String> excluded) throws ParseException, IOException {
        ...
        for (String json : jsons) {
            GitHubJSONTestSuite.runGitHubJsonTransactionTest(json);
        }
    }
