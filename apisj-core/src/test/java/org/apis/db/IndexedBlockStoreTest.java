...
public class IndexedBlockStoreTest {
    ...
    public void test6() throws IOException {
        ...
        try {
            ...
            List<Block> bestLine = TestUtils.getRandomChain(Genesis.getInstance().getHash(), 1, 100);
            ...
            List<Block> forkLine = TestUtils.getRandomChain(forkParentHash, forkParentNumber + 1, 50);
    ...
    public void test8() throws IOException {
        ...
        try {
            ...
            byte[] forkParentHash = bestLine.get(60).getHash();
            long forkParentNumber = bestLine.get(60).getNumber();
            List<Block> forkLine = TestUtils.getRandomChain(forkParentHash, forkParentNumber + 1, 10);
